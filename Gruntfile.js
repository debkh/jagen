...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      babel: {
        files: ['<%= yeoman.client %>/{app,components,models,directives,services}/**/!(*.spec|*.mock).js'],
      ...
      injectJS: {
        files: [
          '<%= yeoman.client %>/{app,components,models,directives,services}/**/!(*.spec|*.mock).js',
          '!<%= yeoman.client %>/app/app.js'
        ],
        tasks: ['injector:scripts']
      },
      injectCss: {
        files: ['<%= yeoman.client %>/{app,components,models,directives,services}/**/*.css'],
        tasks: ['injector:css']
      },
      mochaTest: {
      ...
      injectSass: {
        files: ['<%= yeoman.client %>/{app,components,models,directives,services}/**/*.{scss,sass}'],
        tasks: ['injector:sass']
      },
      sass: {
        files: ['<%= yeoman.client %>/{app,components,models,directives,services}/**/*.{scss,sass}'],
      ...
      livereload: {
        files: [
          '{.tmp,<%= yeoman.client %>}/{app,components,models,directives,services}/**/*.{css,html}',
          '{.tmp,<%= yeoman.client %>}/{app,components,models,directives,services}/**/!(*.spec|*.mock).js',
    ...
    jshint: {
      ...
      all: ['<%= yeoman.client %>/{app,components,models,directives,services}/**/!(*.spec|*.mock|app.constant).js'],
      test: {
        src: ['<%= yeoman.client %>/{app,components,models,directives,services}/**/*.{spec,mock}.js']
      }
    },
    ...
    ngtemplates: {
      ...
      main: {
        cwd: '<%= yeoman.client %>',
        src: ['{app,components,models,directives,services}/**/*.html'],
    ...
    copy: {
      ...
      styles: {
        ...
        cwd: '<%= yeoman.client %>',
        dest: '.tmp/',
        src: ['{app,components,models,directives,services}/**/*.css']
      }
    },
    ...
    babel: {
      ...
      client: {
        files: [{
          expand: true,
          cwd: '<%= yeoman.client %>',
          src: ['{app,components,models,directives,services}/**/!(*.spec).js'],
          dest: '.tmp'
        }]
      },
      server: {
    ...
    injector: {
      ...
      sass: {
        ...
        files: {
          '<%= yeoman.client %>/app/app.scss': [
            '<%= yeoman.client %>/{app,components,models,directives,services}/**/*.{scss,sass}',
      ...
      css: {
        ...
        files: {
          '<%= yeoman.client %>/index.html': [
            '<%= yeoman.client %>/{app,components,models,directives,services}/**/*.css'
          ]
        }
      }
    },
