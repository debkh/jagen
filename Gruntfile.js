...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      babel: {
        files: ['<%= yeoman.client %>/{app,components,models}/**/!(*.spec|*.mock).js'],
      ...
      injectJS: {
        files: [
          '<%= yeoman.client %>/{app,components,models}/**/!(*.spec|*.mock).js',
          '!<%= yeoman.client %>/app/app.js'
        ],
        tasks: ['injector:scripts']
      },
      injectCss: {
        files: ['<%= yeoman.client %>/{app,components,models}/**/*.css'],
        tasks: ['injector:css']
      },
      mochaTest: {
      ...
      injectSass: {
        files: ['<%= yeoman.client %>/{app,components,models}/**/*.{scss,sass}'],
        tasks: ['injector:sass']
      },
      sass: {
        files: ['<%= yeoman.client %>/{app,components,models}/**/*.{scss,sass}'],
      ...
      livereload: {
        files: [
          '{.tmp,<%= yeoman.client %>}/{app,components,models}/**/*.{css,html}',
          '{.tmp,<%= yeoman.client %>}/{app,components,models}/**/!(*.spec|*.mock).js',
    ...
    jshint: {
      ...
      all: ['<%= yeoman.client %>/{app,components,models}/**/!(*.spec|*.mock|app.constant).js'],
      test: {
        src: ['<%= yeoman.client %>/{app,components,models}/**/*.{spec,mock}.js']
      }
    },
    ...
    ngtemplates: {
      ...
      main: {
        cwd: '<%= yeoman.client %>',
        src: ['{app,components,models}/**/*.html'],
    ...
    babel: {
      ...
      client: {
        files: [{
          expand: true,
          cwd: '<%= yeoman.client %>',
          src: ['{app,components,models}/**/!(*.spec).js'],
          dest: '.tmp'
        }]
      },
      server: {
    ...
    injector: {
      ...
      sass: {
        ...
        files: {
          '<%= yeoman.client %>/app/app.scss': [
            '<%= yeoman.client %>/{app,components,models}/**/*.{scss,sass}',
      ...
      css: {
        ...
        files: {
          '<%= yeoman.client %>/index.html': [
            '<%= yeoman.client %>/{app,components,models}/**/*.css'
          ]
        }
      }
    },
